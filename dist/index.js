...
var diffTimeoutPatch = require('diff-timeout-patch');
...
class RecreateTransform {
  ...
  addReplaceTextSteps(op, afterStepJSON) {
    ...
    const textDiffs = this.wordDiffs
      ? diffTimeoutPatch.diffWordsWithSpace(currentText, finalText, textDiffsOptions)
      : diffTimeoutPatch.diffChars(currentText, finalText, textDiffsOptions);
